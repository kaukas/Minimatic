...
class MinificationTestCase(TestCase):
    ...
    def test_paths(self):
        ...
        # minify
        js_source = javascript_link(
            dict(file='/deep/a.js', minify=True, dest='/deep/a.m.js'),
            dict(file='/b.js', minify=True, dest='/b.m.js'))
        self.assert_('"/deep/a.m.js"' in js_source)
        self.assert_('"/b.m.js"' in js_source)

        css_source = stylesheet_link(
            dict(file='/deep/a.css', minify=True, dest='/deep/a.m.css'),
            dict(file='/b.css', minify=True, dest='/b.m.css'))
        self.assert_('"/deep/a.m.css"' in css_source)
        self.assert_('"/b.m.css"' in css_source)

        # root minify and combined
        js_source = javascript_link(
            dict(file='/c.js', minify=True),
            dict(file='/b.js', minify=True),
            combined='cb.mc.js')
        self.assert_('"/cb.mc.js"' in js_source)

        css_source = stylesheet_link(
            dict(file='/c.css', minify=True),
            dict(file='/b.css', minify=True),
            combined='cb.mc.css')
        self.assert_('"/cb.mc.css"' in css_source)

        # root minify
        js_source = javascript_link(
            dict(file='/b.js', minify=True, dest='b.min.js'),
            dict(file='/c.js', minify=True, dest='c.min.js'))
        self.assert_('"/b.min.js"' in js_source)
        self.assert_('"/c.min.js"' in js_source)

        css_source = stylesheet_link(
            dict(file='/b.css', minify=True, dest='b.min.css'),
            dict(file='/c.css', minify=True, dest='c.min.css'))
        ...
        js_source = javascript_link(
            dict(file='/deep/a.js', minify=True),
            dict(file='/deep/d.js', minify=True),
            combined='/deep/ad.js')
        self.assert_('"/deep/ad.js"' in js_source)

        css_source = stylesheet_link(
            dict(file='/deep/a.css', minify=True),
            dict(file='/deep/d.css', minify=True),
            combined='/deep/ad.css')
        self.assert_('"/deep/ad.css"' in css_source)

    def test_two_deep_paths(self):
        js_source = javascript_link(
            dict(file='/js/1.js', minify=True),
            dict(file='/jquery/2.js', minify=True),
            combined='/js/1.2.js')
        self.assert_('"/js/1.2.js"' in js_source)

        css_source = stylesheet_link(
            dict(file='/js/1.css', minify=True),
            dict(file='/jquery/2.css', minify=True),
            combined='/js/1.2.css')
...
## CSS STUFF
    ...
    def test_css_leading_zero(self):
        ...
        css_source = stylesheet_link(
            dict(file='/js/1.css', minify=True, dest='/js/1.min.css'))
